...
import { MOLECULE_META_KIND, } from "./types.js";
export { MOLECULE_META_KIND } from "./types.js";
 ...
 */
function projectMeta(args, result, defaultStyle) {
...
export function apply(ctx, config) {
    ctx.tools.register(defineTool({
        ...
        output: {
            ...
            presentationMeta: (args, value) => projectMeta(args, value, config.defaultStyle),
        },
        async execute(args) {
